...
import serverDb.ServerDbPool;

/**
 *
 * @author Ostap
 */
public class ConnectDbBean extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ConnectDbBean 2</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ConnectDbBean at " + request.getContextPath() + " 2</h1>");
            
            out.println("Подключение:");  
